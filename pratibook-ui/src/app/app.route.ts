...
export const appRoutes: Routes = [
  ...
  {path: 'fiche-auteur', loadChildren: () => import('./auteur/fiche-auteur/fiche-auteur.module').then(mod => mod.FicheAuteurModule)},
  {path: 'oeuvres', loadChildren: () => import('./liste-oeuvre/liste-oeuvre.module').then(mod => mod.ListeOeuvreModule)},
